...
;; Description: Custom Date parser for Org File
;;              Used above at `org-publish-rss--builder`
;; Author:      Rituraj Borpujari <mail.riturajborpujari@gmail.com>
(defun org-file-get-date (file)
  "Return Emacs time object from #+DATE in Org FILE."
  ...
  (with-temp-buffer
    ...
    (if (re-search-forward "^#\\+DATE:[ \t]*\\(.+\\)$" nil t)
      ...
      ;; fallback to file mtime if DATE missing
