...
hi clear
let g:colors_name = 'soaring-skies'
...
if s:t_Co >= 256
  ...
  hi StatusLine ctermfg=236 ctermbg=75 cterm=NONE
  ...
  hi LineNr ctermfg=33 ctermbg=NONE cterm=NONE
  ...
  hi Error ctermfg=255 ctermbg=197 cterm=NONE
